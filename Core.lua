...
ModernWotLKBIS = { version = "0.4.3-beta", revision = 0 }
...
function A:HasAssessment(id)
    return self.items[id] ~= nil or (self.preRaid and self.preRaid[id] ~= nil) or (self.raidItems and self.raidItems[id] ~= nil)
end
